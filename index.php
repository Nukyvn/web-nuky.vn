...
// ==================== LẤY 2 CHƯƠNG TRÌNH KHUYẾN MÃI ====================
$current_date = date('Y-m-d H:i:s');

// Lấy chương trình đang diễn ra (start_date <= NOW <= countdown_end)
$stmt = $pdo->prepare("
    SELECT * FROM promotions
    WHERE start_date <= :current_date
    AND countdown_end >= :current_date2
    AND status = 1
...
<!-- Promotion Section - 2 CHƯƠNG TRÌNH GẦN NHẤT -->
<?php if ($ongoing_promotion || $upcoming_promotion): ?>
<section class="py-12 bg-gray-50">
    <div class="container mx-auto px-4">
        <h2 class="text-3xl md:text-4xl font-bold text-center mb-12" style="color: <?= COLOR_PRIMARY ?>">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="relative overflow-hidden rounded-2xl shadow-2xl transform hover:scale-105 transition duration-300">
                <div class="absolute inset-0 bg-gradient-to-br from-red-500 to-orange-500 opacity-95"></div>
                ...
                <div class="relative z-10 p-8 text-white">
                    ...
                    <?php if ($ongoing_promotion['countdown_end']): ?>
                    <div class="mb-6" x-data="countdown('<?= date('Y-m-d H:i:s', strtotime($ongoing_promotion['countdown_end'])) ?>')">
            ...
            ?>
            <div class="relative overflow-hidden rounded-2xl shadow-2xl transform hover:scale-105 transition duration-300">
                <div class="absolute inset-0 bg-gradient-to-br from-blue-500 to-purple-600 opacity-95"></div>
