...
<section class="py-16 relative overflow-hidden" style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">Đừng bỏ lỡ các chương trình ưu đãi hấp dẫn từ NUKY</p>
        </div>
        <div class="grid <?= $grid_class ?> gap-8 <?= $promo_count === 1 ? 'max-w-4xl mx-auto' : '' ?>">
            ...
            <div
                ...
                <div class="relative">
                    ...
                    <div
                        class="absolute top-4 right-4 bg-red-500 text-white px-4 py-2 rounded-full font-bold text-lg shadow-lg">
